 ...
 */
 ...
 /**
  * Customize the upsells section title on single product pages.
  * 
  * Retrieves and filters the upsells title text from theme options.
  * Provides fallback text if no custom title is set.
  *
  * @since 2.0.0
  * @return string The filtered upsells section title
  */
 function shoptimizer_upsells_title(): string {
